...
Then create a new component, PageTransition.tsx to house the transition. We want to animate any children of this component so we'll pass children as a prop.
...
Use this component as a wrapper to any pages you want to animate. In a Next.js project you would add this to a custom [\_app](https://nextjs.org/docs/advanced-features/custom-app), which wraps the content on all pages.
