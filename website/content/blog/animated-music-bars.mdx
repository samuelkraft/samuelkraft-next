...
.icon {
  ...
  span {
    width: 3px;
    height: 100%;
    background-color: hsl(358, 69.4%, 55.2%);
    border-radius: 3px;
    content: "";
  }
}
  ...
  >
    <span
      style={{
        width: 3,
        height: "100%",
        backgroundColor: "hsl(358, 69.4%, 55.2%)",
        content: "",
        borderRadius: 3,
      }}
    />
