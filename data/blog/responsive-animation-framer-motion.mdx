...
og: '/blog/responsive-animation-framer-motion/og.png'
...
That's it 🙌. You could also use the variable inline `<motion.div animate={isSmall ? { y: 500} : { y: 1000}} />` but I find that using it together with variants is the cleanest way most of the time.
