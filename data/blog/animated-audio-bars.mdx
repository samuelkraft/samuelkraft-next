...
image: '/blog/animated-audio-bars/og.png'
---
...
<div style={{ padding: '50px', backgroundColor: 'var(--bookHeaderBg)', borderRadius: '5px', textAlign: 'center' }}>
  <NowPlayingIcon />
</div>
...
Voila! We now have a smooth working animation, perfect for building a music widget or similar! Check out the [full source code on github](https://github.com/samuelkraft/samuelkraft-next/blob/master/components/nowplaying.module.scss).
