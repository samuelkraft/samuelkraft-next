...
A git workflow I do every day is code something, stash it, checkout latest master, create a new branch, push my new code and create a mr/pr for it. This gets tedious over time given I usually do it 5+ times a day. [Git aliases](https://www.notion.so/My-favorite-productivity-boost-git-newmr-94eb984893e54381a6279e551384fb36) to the rescue!
