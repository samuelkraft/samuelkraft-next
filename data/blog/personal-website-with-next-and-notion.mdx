...
image: '/blog/building-my-personal-website-with-nextjs-backed-by-notion/og.png'
---
...
<Image
  ...
  src={'/blog/building-my-personal-website-with-nextjs-backed-by-notion/books-table.png'}
  width={1672}
  height={700}
/>
...
<Image
  ...
  src={'/blog/building-my-personal-website-with-nextjs-backed-by-notion/book-properties.png'}
  width={1330}
  height={1052}
/>
...
export const getStaticProps: GetStaticProps = async context => {
    ...
    const book = bookData.find(b => slugify([b.Name](http://b.name/), { lower: true }) === slug)
...
That's it, check out an example of this on [/books](/books) and [/books/vagabonding](/books/vagabonding).
