...
og: '/blog/vanilla-extract-with-next-themes/og.png'
...
Vanilla Extract is a really powerful way of working with CSS, and I am very excites for its future. It feels like the natural successor of CSS modules, with a much improved developer experience thanks to being in typescript. I also love how we can still use it existing projects, like next-themes.
